...
order = Order.create(state: 1, client_id: client.id) 
...
order2 = Order.create(state: 2, client_id: client2.id) 
...
order_dish3 = OrderDish.create(order_id: order2.id, dish_id: dish3.id)
order_dish4 = OrderDish.create(order_id: order2.id, dish_id: dish4.id)
